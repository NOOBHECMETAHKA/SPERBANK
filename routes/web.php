...
Route::group(["namespace" => "CardType", "prefix" => "admin", "middleware" => "admin"], function ($id){
    ...
    Route::post("/card-types/update/{id}", [\App\Http\Controllers\CardType\CardTypUpdateController::class, 'update'])->name('card.type.update');
    Route::post("/card-types/delete/{id}", [\App\Http\Controllers\CardType\CardTypUpdateController::class, 'delete'])->name('card.type.delete');
});
...
Route::group(["namespace" => "ScoreType", "prefix" => "admin", "middleware" => "admin"], function ($id){
    ...
    Route::post("/score-types/update/{id}", [\App\Http\Controllers\ScoreType\ScoreTypeUpdateController::class, 'update'])->name('score.type.update');
    Route::post("/score-types/delete/{id}", [\App\Http\Controllers\ScoreType\ScoreTypeDeleteController::class, 'delete'])->name('score.type.delete');
});
...
//   Route::post("/employees/store", [\App\Http\Controllers\Employee\EmployeeAddController::class, 'store'])->name('employee.store');
   Route::get("/employees/edit/{id}", [\App\Http\Controllers\Employee\EmployeeUpdateController::class, 'edit'])->name('employee.edit');
   Route::post("/employees/update/{id}", [\App\Http\Controllers\Employee\EmployeeUpdateController::class, 'update'])->name('employee.update');
//   Route::post("/employees/delete/{id}", [\App\Http\Controllers\Employee\EmployeeDeleteController::class, 'delete'])->name('employee.delete');
});
